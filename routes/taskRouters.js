...
// Update the Task
taskRouters.put('/tasks/:id', authorizeRoles('admin','manager'), authorizeRoles('admin','manager'), upload.single('attachments'), updateTaskRules, validate, taskController.updateTask);
